...
export const GUESTS: Guest[] = [
  {
    ...
    color: 0x4169E1,
    px: 200,  py: 680,   // tile ~6,21 — open area
    x: 6,   y: 21,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'Co-Founder, a16z',
    color: 0x8B0000,
    px: 1050,  py: 720,   // tile ~33,22 — open area
    x: 33,   y: 22,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CEO, NVIDIA',
    color: 0x76B900,
    px: 380,  py: 800,   // tile ~12,25 — open area
    x: 12,   y: 25,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CEO, AMD',
    color: 0xFF6B00,
    px: 700,  py: 680,   // tile ~22,21 — open area
    x: 22,   y: 21,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CEO, Scale AI',
    color: 0x00CED1,
    px: 950,  py: 780,   // tile ~30,24 — open area
    x: 30,   y: 24,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CEO, OpenAI',
    color: 0x1A1A2E,
    px: 180,  py: 900,   // tile ~6,28 — open area
    x: 6,   y: 28,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CEO, Microsoft',
    color: 0x00A4EF,
    px: 520,  py: 820,   // tile ~16,26 — open area
    x: 16,   y: 26,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xFF5A5F,
    px: 820,  py: 880,   // tile ~26,28 — open area
    x: 26,   y: 28,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0x6772E5,
    px: 1060,  py: 840,   // tile ~33,26 — open area
    x: 33,   y: 26,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xCC785C,
    px: 280,  py: 980,   // tile ~9,31 — open area
    x: 9,   y: 31,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xF7931A,
    px: 600,  py: 920,   // tile ~19,29 — open area
    x: 19,   y: 29,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xFF69B4,
    px: 920,  py: 960,   // tile ~29,30 — open area
    x: 29,   y: 30,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0x9370DB,
    px: 180,  py: 1080,   // tile ~6,34 — open area
    x: 6,   y: 34,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xFF8C00,
    px: 480,  py: 1020,   // tile ~15,32 — open area
    x: 15,   y: 32,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0x20B2AA,
    px: 780,  py: 1040,   // tile ~24,32 — open area
    x: 24,   y: 32,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xDC143C,
    px: 1060,  py: 1000,   // tile ~33,31 — open area
    x: 33,   y: 31,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xFF4A00,
    px: 300,  py: 1160,   // tile ~9,36 — open area
    x: 9,   y: 36,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xF45D48,
    px: 620,  py: 1120,   // tile ~19,35 — open area
    x: 19,   y: 35,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xF7A800,
    px: 940,  py: 1140,   // tile ~29,36 — open area
    x: 29,   y: 36,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0x2D2D2D,
    px: 180,  py: 1220,   // tile ~6,38 — open area
    x: 6,   y: 38,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0x0077B5,
    px: 500,  py: 1180,   // tile ~16,37 — open area
    x: 16,   y: 37,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0xA2AAAD,
    px: 800,  py: 1220,   // tile ~25,38 — open area
    x: 25,   y: 38,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0x4285F4,
    px: 1060,  py: 1180,   // tile ~33,37 — open area
    x: 33,   y: 37,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CPO, LinkedIn',
    color: 0x0A66C2,
    px: 360,  py: 1260,   // tile ~11,39 — open area
    x: 11,   y: 39,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CEO, Palantir',
    color: 0x1C1C1E,
    px: 700,  py: 1260,   // tile ~22,39 — open area
    x: 22,   y: 39,
    questions: [
      {
