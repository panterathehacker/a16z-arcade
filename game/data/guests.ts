...
export const GUESTS: Guest[] = [
  {
    ...
    color: 0x4169E1,
    px: 448,  py: 256,   // center path area
    x: 14,   y: 8,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CEO, NVIDIA',
    color: 0x76B900,
    px: 352,  py: 416,   // path top section
    x: 11,   y: 13,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CEO, Scale AI',
    color: 0x00CED1,
    px: 864,  py: 352,   // path top section
    x: 27,   y: 11,
    questions: [
      {
  ...
  },
  {
    ...
    color: 0x4285F4,
    px: 1056, py: 1120,  // bottom section
    x: 33,   y: 35,
    questions: [
      {
  ...
  },
  {
    ...
    title: 'CPO, LinkedIn',
    color: 0x0A66C2,
    px: 384,  py: 1216,  // bottom section (same y as player but different x)
    x: 12,   y: 38,
    questions: [
      {
